...
export function PlanCanvas({ doc, onChange, tool, activeKind, visible, selection, onSelect, onToolDone }: Props) {
  ...
  return <svg ref={svgRef} className="h-full w-full select-none blueprint-surface" style={{ cursor }} onWheel={handleWheel} onMouseDown={onBackgroundDown} onMouseMove={onMouseMove} onMouseUp={endInteraction} onMouseLeave={endInteraction}>
    ...
    {editingPoint && <foreignObject x="18" y="48" width="390" height="560">
